      ...
      <div className="landing-page">
        ...
        <header className="landing-header">
          <div className="landing-logo">
            <span className="logo-icon">≡ƒôí</span>
          ...
          <div className="hero-content-landing">
            ...
            <div className="hero-buttons">
              <button className="btn-primary" onClick={() => { setAuthMode("register"); setShowAuthModal(true); setAuthError(null); }}>
                Get Started Free <span>ΓåÆ</span>
              </button>
        ...
        <section id="features" className="features-section">
          ...
          <div className="features-grid">
            <div className="feature-card">
              <div className="feature-icon-large">≡ƒî▒</div>
            ...
            <div className="feature-card">
              <div className="feature-icon-large">≡ƒôè</div>
            ...
            <div className="feature-card">
              <div className="feature-icon-large">≡ƒöÆ</div>
              <h3>Secure Access</h3>
        ...
        <section className="cta-section">
          <div className="cta-content">
            ...
            <button className="btn-primary btn-large" onClick={() => { setAuthMode("register"); setShowAuthModal(true); setAuthError(null); }}>
              Start Free Today <span>ΓåÆ</span>
            </button>
          </div>
        </section>
        ...
        {showAuthModal && (
          <div className="modal-overlay" onClick={() => setShowAuthModal(false)}>
            <div className="auth-modal" onClick={(e) => e.stopPropagation()}>
              <button className="modal-close" onClick={() => setShowAuthModal(false)}>├ù</button>
...
<div className="dashboard-brand">
          <span className="brand-icon">≡ƒôí</span>
        ...
        <div className="modal-overlay" onClick={() => { setShowAddDeviceModal(false); setAddPickMode(false); }}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button className="modal-close" onClick={() => { setShowAddDeviceModal(false); setAddPickMode(false); }}>├ù</button>
            </div>
